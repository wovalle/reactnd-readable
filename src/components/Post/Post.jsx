        ...
        <div className="col-md-10 offset-md-1">
          <div className="row">
            <div className="col-md-8">
              ...
              <h6>Posted by Start Bootstrap on August 24, 2017 at 23:34</h6>
            </div>
            ...
            <div className="card my-4">
              ...
              <div className="card-body">
                <form>
                  ...
                  <div className="form-group">
                    <label className="col-form-label" htmlFor="comment-author">Author:</label>
            ...
            <div className="comment media mb-4">
              ...
              <div className="media-body">
                <div className="media-title">
                  ...
                  <div className="comment-actions-buttons d-inline float-right">
                    <a href="" className="pr-1">edit</a>
                    <a href="" className="pr-1" >delete</a>
                  </div>
                </div>
